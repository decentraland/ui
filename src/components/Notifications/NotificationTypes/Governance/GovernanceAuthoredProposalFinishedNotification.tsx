...
import { CommonNotificationProps, GovernanceAuthoredProposalFinishedNotification } from '../../types'
...
const i18N = {
  en: {
    description: (
      ...
      <>
        The votes are in! Find out the outcome of the voting on <a className="dcl notification-link" href={link}> your proposal</a>.
      </>
    ),
  ...
  es: {
    description: (
      ...
      <>
        Ya estan los votos! Descubre el resultado de la votacion en <a href={link} className="dcl notification-link">tu propuesta</a>.
      </>
    ),
  ...
  zh: {
    description: (
      ...
      <>
        投票结果出来了！<a href={link} className="dcl notification-link">了解您提案的投票结果</a>.
      </>
    ),
    title: '您的提案投票结束'
  }
