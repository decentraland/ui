...
const i18N = {
  en: {
    description: (
      ...
      <>
        <a href={link} className="dcl notification-link">Discover the results</a> of the proposal you participated in as a voter. Your input matters!
      </>
    ),
  ...
  es: {
    description: (
      ...
      <>
        <a href={link} className="dcl notification-link">Descubre los resultados</a> de la propuesta en la que participaste como votante. Tu opinion es importante!
      </>
    ),
  ...
  zh: {
    description: (
      ...
      <>
        <a href={link} className="dcl notification-link">了解您作为选民参与的提案的结果</a>. 您的意见很重要！
      </>
    ),
    title: '您已投票的提案投票结束'
  }
...
const GovernanceVotingEndedVoterNotification = ({
  ...
  >
    <p className="dcl notification-item__content-title">
      {i18N[locale].title}{' '}
      <span className="dcl notification-text-highlighted">{notification.metadata.proposalTitle}</span>
    </p>
