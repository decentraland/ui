...
import { CommonNotificationProps, GovernanceCoauthorRequestedNotification } from '../../types'
...
const i18N = {
  en: {
    description: (
      ...
      <>
        You've been invited to collaborate as a co-author on a published proposal. Accept it or reject it <a href={link} className="dcl notification-link">here</a>.
      </>
    ),
  ...
  es: {
    description: (
      ...
      <>
        Has sido invitado a colaborar como coautor en un propuesta publicada. Aceptala o rechazala <a href={link} className="dcl notification-link">aqui</a>.
      </>
    ),
  ...
  zh: {
    description: (
      ...
      <>
       您受邀作为共同作者参与一项已发表提案的合作. <a href={link} className="dcl notification-link">在此接受或拒绝</a>.
      </>
    ),
    title: '收到共同作者申请'
  }
