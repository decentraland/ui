...
const i18N = {
  en: {
    description: (
      ...
      <>
        Congratulations! <a className="dcl notification-link" href={link}>Your Project</a> has been successfully enacted and a funding Vesting Contract was created.
      </>
    ),
  ...
  es: {
    description: (
      ...
      <>
        Felicitaciones! <a className="dcl notification-link" href={link}>Tu proyecto</a> ha sido aprobado y un Vesting Contract de financiamiento fue creado.
      </>
    ),
  ...
  zh: {
    description: (
      ...
      <>
        恭喜您！<a className="dcl notification-link" href={link}>您的项目已成功立项</a>，并签订了资金归属合同.
      </>
    ),
    title: '您的项目已获得资助'
  }
