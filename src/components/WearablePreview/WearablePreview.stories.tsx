...
export const PreviewATokenFromMumbai: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const PreviewATextureWearable: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const UsingCustomShape: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        contractAddress="0xe3d2c4ec777fb88dd219905cd896f79a592adf30"
...
export const UsingAProfileEmote: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const UsingAWearablePreviewProfileEmote: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const UsingOnLoadCallback: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        contractAddress="0xee8ae4c668edd43b34b98934d6d2ff82e41e6488"
...
export const UsingOnErrorCallback: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const WithHotReload: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
...
export const WithoutBackgroundOrTransparentBackground: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
...
export const EmoteEvents: Story = {
  render: () => {
...
export const PreviewFromAFile: Story = {
  render: () => {
...
export const EmoteThumbnailPicker: Story = {
  render: () => {
    const inputRef = React.useRef<HTMLInputElement>()
    const [file, setFile] = React.useState<File | null>(null)
    const [screenshot, setScreenshot] = React.useState('')
...
export const CameraFromTheFront: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const CameraFromTheTop: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
...
export const CustomPeerUrl: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        profile="default"
...
export const WithoutPanning: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        profile="0xc85a0a34d5f9f2239ab0622a41a2c2560ff119c6"
...
export const WithLockedAlpha: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        profile="0xc85a0a34d5f9f2239ab0622a41a2c2560ff119c6"
...
export const WithLockedBeta: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        profile="0xc85a0a34d5f9f2239ab0622a41a2c2560ff119c6"
...
export const WithLockedRadius: Story = {
  render: () => (
    <div className="WearablePreview-story-container">
      <WearablePreview
        profile="0xc85a0a34d5f9f2239ab0622a41a2c2560ff119c6"
